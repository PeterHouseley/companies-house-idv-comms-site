...
for asset in ['idv-comms-workflow.svg', 'idv-deadline-control-room.svg', 'idv-partner-briefing-file.svg', 'idv-correspondence-desk.svg', 'idv-evidence-matrix.svg', 'idv-client-question-queue.svg', 'idv-risk-register.svg', 'idv-appointment-book.svg']:
    print(out / asset)
